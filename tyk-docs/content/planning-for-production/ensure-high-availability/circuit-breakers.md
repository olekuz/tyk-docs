...
![Circuit Breaker Example](/img/dashboard/system-management/circuit-breaker-diagram.png)
...
When a circuit breaker trips, it will fire a `BreakerTriggered` event which you can define actions for in the `event_handlers` section (see [Event Data](/basic-config-and-security/report-monitor-trigger-events/event-data/) and [Event Types](/basic-config-and-security/report-monitor-trigger-events/event-types/) for more information):
...
![Plugin dropdown list](/img/2.10/circuit_breaker.png)
...
![Circuit breaker configuration form](/img/2.10/ciruit_breaker_settings.png)
