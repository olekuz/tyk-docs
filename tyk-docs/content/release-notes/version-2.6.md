...
See [List Key Requests](/tyk-dashboard-api/manage-key-requests/#list-key-requests) for more details.
...
![Blacklist Support](/img/release-notes/blacklist_option.png)
