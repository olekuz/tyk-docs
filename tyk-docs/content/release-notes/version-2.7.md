...
Instead of setting permissions per user, you can now [create a user group](/basic-config-and-security/security/dashboard/create-user-groups/), and assign it to multiple users. It works for Single Sign-On too, just specify group ID during [SSO API](docs/tyk-apis/tyk-dashboard-admin-api/sso/) flow.
