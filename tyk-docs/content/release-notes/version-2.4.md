...
[Docs](/basic-config-and-security/security/gateway/gateway-api/)
...
Hybrid users should follow the upgrade instructions [here](/get-started/with-tyk-hybrid/tutorials/install-hybrid-gateway/#upgrade-hybrid).
