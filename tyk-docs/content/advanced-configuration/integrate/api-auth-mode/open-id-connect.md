...
![Tyk OpenID Connect with Auth0](/img/diagrams/openid_connect.png)
...
![Default JWT Policy](/img/dashboard/system-management/jwt_default_policy.png)

3. At the bottom of the **Core Settings** tab, select **Use Scope Claim**.
![Use Scope Claim](/img/2.10/jwt_scope_claim.png)
